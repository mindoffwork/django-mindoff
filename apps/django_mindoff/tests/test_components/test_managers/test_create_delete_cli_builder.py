...
# ===========================================================================
# TestCreateManagerFlows  (all interactive flow functions)
# ===========================================================================


class TestCreateManagerFlows:
    """Cover every function in _create.py not exercised by TestCreateManager."""
    ...
    # ------------------------------------------------------------------
    # _normalise_foreign_key_field_name
    # ------------------------------------------------------------------
